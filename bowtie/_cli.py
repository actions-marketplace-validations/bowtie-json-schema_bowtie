    ...
    def convert(  # type: ignore[reportIncompatibleMethodOverride]
        ...
        try:
            ...
            error = DiagnosticError(
                ...
                hint_stmt=(
                    "This likely indicates the report was produced "
                    "incorrectly, for example by concatenating two "
                    "partial reports together. Ensure you are passing "
                    "in a single report generated by Bowtie."
                ),
            )
            STDERR.print(error)
            ctx.exit(EX.DATAERR)
